...
<?php
    ...
    if(isset($_POST['rn'],$_POST['p1'],$_POST['p2'],$_POST['p3'],$_POST['p4'],$_POST['p5'],$_POST['lab1'],$_POST['lab2'],$_POST['class'])) {
        $rno=$_POST['rn'];
        ...
        $sql="UPDATE `result` SET `p1`='$p1',`p2`='$p2',`p3`='$p3',`p4`='$p4',`p5`='$p5',`lab1`='$lab1',`lab2`='$lab2',`marks`='$marks',`percentage`='$percentage' WHERE `rno`='$rno' and `class`='$class_name'";
